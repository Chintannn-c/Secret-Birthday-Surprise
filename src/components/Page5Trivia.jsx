...
const QUOTES = [
  ...
  {
    id: 9,
    quote: "Udita, I just wanted to say how amazing it is to have you as a friend! From being school classmates to now, it’s been such a wonderful journey having you around. You bring so much positivity, fun, and bright energy wherever you go. Seeing how happy you make my best friend genuinely makes me happy too, and I’m really grateful that our friendship has lasted all these years. ❤️\n\nAnd honestly, seeing both of you together and so happy is something that makes me smile too! 😊❤️",
    answer: "Yug",
    aliases: ["yug", "yugbhai", "yug bhai", "yugu"],
    relationship: "Schoolmate & Joyful Friend 😊❤️",
    tagline: "“Seeing both of you so happy makes me smile!” ✨",
    avatarIcon: "😊",
    themeColor: "#bae6fd",
  },
  {
    id: 10,
    quote: "Happy Birthday to Udita, our future CA! 🎂❤️\n\nAn unexpected friend who somehow became such an important part of the journey. Life really does surprise you with the people you never expected to meet but end up being grateful for. Wishing you lots of success, happiness, and of course, a bright future as a CA! 😊✨",
    answer: "Krishna",
    aliases: ["krishna", "krishnabhai", "krishna", "krish"],
    relationship: "Unexpected Friend & Well-Wisher 🌟",
    tagline: "“Grateful for the unexpected friendships!” ✨",
    avatarIcon: "🌸",
    themeColor: "#fbcfe8",
  },
  {
    id: 11,
    quote: "To my best friend!!! Ofc my first impression was bitch fir bechari thi😭, no matter how much you’ll overthink stuff I’m always here to give you reassurance. Do whatever your heart desires. I’m always here by your side.\n\nLove you tons",
    answer: "Hanu",
    aliases: ["hanu", "hanuu", "hanu", "hany"],
    relationship: "Reassurance Queen & Best Friend 🫂💖",
    tagline: "“First impression: Bitch fir bechari thi 😭❤️”",
    avatarIcon: "🫂",
    themeColor: "#fecdd3",
  },
  {
    id: 12,
    quote: "To the sweetest person with the most genuine and warmest friend vibe—thank you for always being yourself and bringing such positive energy wherever you go. ❤️✨",
    answer: "Priyanka",
    aliases: ["priyanka", "priya", "priyankaa", "priyu", "priyanka"],
    relationship: "Warmest Vibe & Sweet Friend 🌸✨",
    tagline: "“Thank you for bringing such positive energy always!” 💖",
    avatarIcon: "💖",
    themeColor: "#fed7aa",
  },
  {
